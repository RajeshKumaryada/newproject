...
<head>
  @include('user_template.head', ["title"=>"Assign Content to Writer"])
</head>
              ...
              <div class="card card-primary">
                ...
                <form id="content-demand-form">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="{{url('')}}/content-writer/request/content/list" class="btn btn-secondary">Back to List</a>
  ...
  <script>
    ...
    $("#content-demand-form").on('submit', function(e) {
      ...
      if (!isAjax) {
        ...
        $.ajax({
          type: 'POST',
          url: `{{url('')}}/ajax/content-writer/request/content/assign/save`,
          ...
          success: function(res) {
            ...
            if (res.code === 200) {
              ...
              setTimeout(() => {
                window.location.replace(`{{url('')}}/content-writer/request/content/list`);
              }, 1000);
