        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <div class="card">
                @if ($ext == 'pdf')
                <a href="{{ url('') }}/users/employee-documents/images/{{ $row->images }}" download>
                </a>
                @else
                <a href="{{ url('') }}/users/employee-documents/images/{{ $row->images }}" data-toggle="lightbox" data-title="{{ $tempTitle }}" data-gallery="gallery">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  @php
                  $ext_bank = '';
                  if (!empty($bankinfo->passbook)) {
                  $ext_bank = pathinfo($bankinfo->passbook, PATHINFO_EXTENSION);
                  }
                  @endphp
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="card">
                        @if ($ext == 'pdf')
                        <a href="{{ url('') }}/users/employee-documents/images/{{ $bankinfo->passbook }}" download>
                        </a>
                        @else
                        <a href="{{ url('') }}/users/employee-documents/images/{{ $bankinfo->passbook }}" data-toggle="lightbox" data-title="{{ $bankinfo->bank_name }}" data-gallery="gallery">
                  ...
                  <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item pl-0">
                      ...
                      <p class="pt-2">Note:
                        {{ $bankinfo->usersBankInfoTemp->remark }}
                      </p>
                    </li>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-footer">
                    <button type="submit" id="loader" class="btn btn-primary float-right">Update User
                      Address</button>
                  </div>
                </div>
                <!-- /.card -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="file" name="vac_certificate_one" id="vac_certificate_one" class="form-control">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="file" name="vac_certificate_two" id="vac_certificate_two" class="form-control">
                        </div>
                      </div>
