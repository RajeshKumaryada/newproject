...
<head>
  @include('admin.template.head', ["title"=>"Designer Task Info"])
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0">Designer Task Info</h1>
            </div>
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Designer Task Info</h3>
                </div>
                <!-- /.card-header -->
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      let url = `{{url('')}}/ajax/admin/task/users/designer`;
    ...
    $('#user-task-tbl').on('click', '.finish-task-btn', function() {
      ...
      $(this).parent('form').submit(function(e) {
        ...
        if (!isAjax) {
          ...
          $.ajax({
            type: 'POST',
            url: `{{url('')}}/ajax/admin/task/designer/finish`,
            data: new FormData(this),
            contentType: false,
            processData: false,
            success: function(res) {
