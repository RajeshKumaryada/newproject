...
<head>
  @include('admin.template.head', ["title"=>"HR Task Info"])
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">HR Task Info</h3>
                </div>
                <!-- /.card-header -->
                    ...
                    <div class="col-md-12 mb-2">
                      <form id="select-user-form">
                        ...
                        <div class="row">
                          ...
                          <input type="hidden" name="usertype" value="human-resource">
                          <div class="col-md-6">
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      let url = `{{url('')}}/ajax/admin/task/users/human-resource`;
    ...
    $('#user-task-tbl').on('click', '.finish-task-btn', function() {
      ...
      $(this).parent('form').submit(function(e) {
        ...
        if (!isAjax) {
          ...
          $.ajax({
            type: 'POST',
            url: `{{url('')}}/ajax/admin/task/human-resource/finish`,
            data: new FormData(this),
            contentType: false,
            processData: false,
            success: function(res) {
