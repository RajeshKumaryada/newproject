...
<head>
  @include('admin.template.head', ["title"=>"SEO Task Info"])
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">SEO Task Info</h3>
                </div>
                <!-- /.card-header -->
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      let url = `{{url('')}}/ajax/admin/task/users/seo`;
    ...
    $('#user-task-tbl').on('click', '.finish-task-btn', function() {
      ...
      $(this).parent('form').submit(function(e) {
        ...
        if (!isAjax) {
          ...
          $.ajax({
            type: 'POST',
            url: `{{url('')}}/ajax/admin/task/seo/finish`,
            data: new FormData(this),
            contentType: false,
            processData: false,
            success: function(res) {
