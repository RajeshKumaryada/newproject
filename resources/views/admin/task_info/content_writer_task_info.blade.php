...
<head>
  @include('admin.template.head', ["title"=>"Content Writer Task Info"])
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0">Content Writer Task Info</h1>
            </div>
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Content Writer Task Info</h3>
                </div>
                <!-- /.card-header -->
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 mb-2">
                      <form id="select-user-form">
                        ...
                        <div class="row">
                          ...
                          <input type="hidden" name="usertype" value="content-writer">
                          <div class="col-md-6">
                    ...
                    <div class="col-md-12 mb-4">
                      <div class="row">
                        <div class="col-md-8">
                          <strong>Total Words Count - <span id="tot_words_count">0</span> </strong>
                        </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      let url = `{{url('')}}/ajax/admin/task/users/content-writer`;
    ...
    $(frmEle).on('submit', function(e) {
      ...
      if (!isAjax) {
        ...
        $.ajax({
          type: 'POST',
          url: `{{url('')}}/ajax/admin/task/content-writer`,
    ...
    function setTableData(tbl_id, response) {
      ...
      response.data.forEach((ele, idx) => {
        ...
        if (ele.action !== 'Finished') {
          ...
          tot_words_count += ele.word_count;
        }
      ...
      $('#tot_words_count').html(tot_words_count);
    ...
    $('#user-task-tbl').on('click', '.finish-task-btn', function() {
      ...
      $(this).parent('form').submit(function(e) {
        ...
        if (!isAjax) {
          ...
          $.ajax({
            type: 'POST',
            url: `{{url('')}}/ajax/admin/task/content-writer/finish`,
            data: new FormData(this),
            contentType: false,
            processData: false,
            success: function(res) {
