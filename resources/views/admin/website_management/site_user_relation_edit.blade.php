...
<head>
  @include('admin.template.head', ["title"=>"Edit Sites for Single User"])
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0">Edit Sites for Single User</h1>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-control">{{$user->username}} - {{$user->designation()->first()->des_name}}</div>
                        </div>
                      </div>
  ...
  <script>
    ...
    function getSiteList(dataTbl) {
      dataTbl.clear().draw();
      let url = `{{url('')}}/ajax/admin/website/manage/edit-relation-with-user/{{$userId}}/fetch`;
