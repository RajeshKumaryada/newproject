...
<head>
  @include('admin.template.head', ["title"=>"Create Checklist Rule"])
</head>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0">Create Checklist Rule</h1>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Create Rule Form</h3>
                </div>
                <!-- /.card-header -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="checklist_name" id="checklist_name" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="checklist_text" id="checklist_text" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select class="form-control select2bs4" name="checklist_group_id" id="checklist_group_id" style="width: 100%;">
                            ...
                            <option value="{{$row->checklist_group_id}}">{{$row->group_name}}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
  ...
  <script>
    ...
    $(frmEle).on('submit', function(e) {
      ...
      if (!isAjax) {
        ...
        $.ajax({
          type: 'POST',
          url: `{{url('')}}/ajax/admin/checklist/rule/create`,
