    ...
    function setTableData(tbl_id, response) {
      ...
      response.data.forEach((ele, idx) => {
        ...
        if (ele.alarm_status == null) {
          alarm_status = `<span class="badge badge-danger"><i class="far fa-bell-slash"></i></span>`;
        } else if (ele.alarm_status == 2) {
          alarm_status = `<span class="badge badge-danger"><i class="far fa-bell-slash"></i></span>`;
        } else if (ele.alarm_status == 1) {
          alarm_status = `<span class="badge badge-success"><i class="fa fa-check" aria-hidden="true"></i>
</span>`;
        }
