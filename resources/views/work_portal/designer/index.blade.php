...
<head>
  @include('user_template.head', ['title'=>'Designer'])
</head>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0">Designer Work Report</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
  ...
  <script>
    ...
    $(formEle).on('submit', function(e) {
      ...
      if (!isAjax) {
        ...
        $.ajax({
          type: 'POST',
          url: `{{url('')}}/ajax/designer/task/add`,
    ...
    function getTableInfoData(taskInfoTbl) {
      ...
      let url = `{{url('')}}/ajax/designer/task/list`;
    ...
    function setTableData(tbl_id, response) {
      ...
      $(eleTaskBtn).on('click', function(e) {
        ...
        if (!isAjax) {
          ...
          $.ajax({
            type: 'POST',
            url: `{{url('')}}/ajax/designer/task/finish`,
            data: {
              status: status,
