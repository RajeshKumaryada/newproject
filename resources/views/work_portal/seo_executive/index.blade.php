...
<head>
  @include('user_template.head', ['title'=>'SEO Executive'])
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <select name="task_details" id="task_details" class="form-control w-100">
  ...
  <script>
    ...
    function getTableInfoData(taskInfoTbl) {
      ...
      let url = `{{url('')}}/ajax/seo/task/list`;
    ...
    function getSeoTaskListData(ele_id) {
      ...
      getAjaxData(ele_id, url, appendChildSelect);
    ...
    $(document).ready(function() {
      ...
      isAjax = false;
      $("#task-info-tbl").on('click', eleTaskBtn, function(e) {
