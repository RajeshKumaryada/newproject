...
<head>
  @include('user_template.head', ['title'=>'Back Office'])
</head>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0">Back Office Work Report</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
  ...
  <script>
    ...
    $(formEle).on('submit', function(e) {
      ...
      if (!isAjax) {
        ...
        $.ajax({
          type: 'POST',
          url: `{{url('')}}/ajax/back-office/task/add`,
    ...
    function getTableInfoData(taskInfoTbl) {
      ...
      let url = `{{url('')}}/ajax/back-office/task/list`;
    ...
    function setTableData(tbl_id, response) {
      ...
      $(eleTaskBtn).on('click', function(e) {
        ...
        if (!isAjax) {
          ...
          $.ajax({
            type: 'POST',
            url: `{{url('')}}/ajax/back-office/task/finish`,
            data: {
              status: status,
