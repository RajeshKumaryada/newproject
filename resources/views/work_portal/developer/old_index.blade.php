...
<head>
  @include('user_template.head', ['title'=>'Developer'])
</head>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0">Developer Work Report</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Task Add Form</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
  ...
  <script>
    ...
    $(formEle).on('submit', function(e) {
      ...
      if (!isAjax) {
        ...
        $.ajax({
          type: 'POST',
          url: `{{url('')}}/ajax/developer/task/add`,
    ...
    function getTableInfoData(taskInfoTbl) {
      ...
      let url = `{{url('')}}/ajax/developer/task/list`;
    ...
    function setTableData(tbl_id, response) {
      ...
      $(eleTaskBtn).on('click', function(e) {
        ...
        if (!isAjax) {
          ...
          $.ajax({
            type: 'POST',
            url: `{{url('')}}/ajax/developer/task/finish`,
            data: {
              status: status,
            ...
            success: function(res) {
              ...
              if (res.code === 200) {
                ...
                // if (liveTaskIntervel > 0) {
                //   clearInterval(liveTaskIntervel);
                //   liveTaskIntervel = 0;
                // }
