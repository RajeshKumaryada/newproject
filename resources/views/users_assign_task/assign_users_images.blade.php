                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <a href="{{url('')}}/users/assign-task/{{$row->images}}" data-toggle="lightbox" data-title="Assign Task Files" data-gallery="gallery">
                                                <img src="{{url('')}}/users/assign-task/{{$row->images}}" class="img-fluid mb-2 height" alt="Task" />
                                            </a>

                                            <div class="text-center">
                                                <a href="{{url('')}}/users/assign-task/{{$row->images}}" target="_blank">
                                                View File
                                                </a>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            @php
                                                ...
                                                @if($ext == 'png' || $ext == 'jpeg' || $ext == 'jpg')
                                                <a href="{{url('')}}/users/assign-task/{{$row->images}}" data-toggle="lightbox" data-title="User Assign Task" data-gallery="gallery">
                                                <img src="{{url('')}}/users/assign-task/{{$row->images}}" class="img-fluid mb-2 height" alt="Seo Task" />
                                            </a>
                                            ...
                                            <div class="text-center">
                                                <a href="{{url('')}}/users/assign-task/{{$row->images}}" target="_blank" download>
                                                <i class="fas fa-file-download"></i> Download File
                                                </a>
                                            </div>
                                                @endif
