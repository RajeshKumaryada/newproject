  ...
  public function getWorkingUsersTime()
  {
    ...
    foreach ($users as $row1) {
      ...
      if ($row1->post === 1) {
        ...
        $taskLFirstStart_time = ContentWriterTask::select('start_time')
        ->where('user_id', $row1->user_id)
        ->whereDate('start_time', date("Y-m-d"))
        ->orderBy('user_id', 'DESC')
        ->first();

        $taskLastEnd_time = ContentWriterTask::select('end_time')
          ->where('user_id', $row1->user_id)
          ->whereOr('status','1')
        ...
        $returnData[] = $workingUsersData->calculateForAdmin($taskList, $row1,$taskLFirstStart_time, $taskLastEnd_time);
      ...
      //Designer
        ...
        $taskLFirstStart_time = DesignerTask::select('start_time')
        ->where('user_id', $row1->user_id)
        ->whereDate('start_time', date("Y-m-d"))
        ->orderBy('user_id', 'DESC')
        ->first();

        $taskLastEnd_time =  DesignerTask::select('end_time')
          ->where('user_id', $row1->user_id)
          ->whereDate('end_time', date("Y-m-d"))
          ->whereOr('status','1')
          ->orderBy('id', 'DESC')
      ...
      //Developer
        ...
        $taskLFirstStart_time = DeveloperTask::select('start_time')
        ->where('user_id', $row1->user_id)
        ->whereDate('start_time', date("Y-m-d"))
        ->orderBy('user_id', 'DESC')
        ->first();
        ...
        $taskLastEnd_time =  DeveloperTask::select('end_time')
          ->where('user_id', $row1->user_id)
          ->whereOr('status','1')
          ->whereDate('end_time', date("Y-m-d"))
          ->orderBy('id', 'DESC')
      ...
      //Seo
        ...
        $taskLFirstStart_time = SeoExecutiveTask::select('start_time')
        ->where('user_id', $row1->user_id)
        ->whereDate('start_time', date("Y-m-d"))
        ->orderBy('user_id', 'DESC')
        ->first();
        ...
        $taskLastEnd_time =  SeoExecutiveTask::select('end_time')
          ->where('user_id', $row1->user_id)
          ->whereOr('status','1')
          ->whereDate('end_time', date("Y-m-d"))
          ->orderBy('id', 'DESC')
      ...
      //Hr
        ...
        $taskLFirstStart_time = HumanResourceTask::select('start_time')
        ->where('user_id', $row1->user_id)
        ->whereDate('start_time', date("Y-m-d"))
        ->orderBy('user_id', 'DESC')
        ->first();
        ...
        $taskLastEnd_time =  HumanResourceTask::select('end_time')
          ->where('user_id', $row1->user_id)
          ->whereOr('status','1')
          ->whereDate('end_time', date("Y-m-d"))
          ->orderBy('id', 'DESC')
      ...
      //Back Office
        ...
        $taskLFirstStart_time = BackOfficeTask::select('start_time')
        ->where('user_id', $row1->user_id)
        ->whereDate('start_time', date("Y-m-d"))
        ->orderBy('user_id', 'DESC')
        ->first();
        ...
        $taskLastEnd_time =  BackOfficeTask::select('end_time')
          ->where('user_id', $row1->user_id)
          ->whereOr('status','1')
          ->whereDate('end_time', date("Y-m-d"))
          ->orderBy('id', 'DESC')
