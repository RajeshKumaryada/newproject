...
class OrderReportMonthCtrl extends Controller
{
  ...
  public function viewMonthReport()
  {
    ...
    return view('admin.order_management.order_month_report', ['users' => $users, 'websites' => $websites]);
  }
  ...
  public function fecthMonthReport(Request $request)
  {
    ...
    $orders = $orders->groupBy('ord_month')
