...
namespace App\Http\Controllers\WorkPortal\BackOffice;
...
class BackOfficeTaskCtrl extends Controller
{

  public function index()
  {
    return view('work_portal.back_office.index');
  }
  ...
  public function addTask(Request $request)
  {
    ...
    $taskCount = BackOfficeTask::where('user_id', $trackSession->userId())
      ->where('complete', 0)
  ...
  public function finishTask(Request $request)
  {
    ...
    $devtask = BackOfficeTask::find($task_id);
  ...
  public function getTodayTaskList(Request $request)
  {
    ...
    //check if running task available
    $taskList = BackOfficeTask::where('user_id', $trackSession->userId())
      ->whereDate('start_time', date("Y-m-d"))
      ->orderBy('id', 'DESC')
      ->get();
