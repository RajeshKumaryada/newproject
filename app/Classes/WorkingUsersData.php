...
class WorkingUsersData
{
   ...
   */
  public function calculateForAdmin($taskList, $users,$taskLFirstStart_time, $taskLastEnd_time)
  {
    ...
    foreach ($taskList as $row) {
      ...
      $start_first_time = $taskLFirstStart_time->start_time;
    ...
    if($taskLastEnd_time == ''){
      ...
      $end_time_last = $taskLastEnd_time->end_time;
